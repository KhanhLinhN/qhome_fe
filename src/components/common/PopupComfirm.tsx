...
const PopupConfirm = ({ isOpen, onClose, onConfirm, popupTitle, popupContext }: PopupConfirmProps) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-[#E7E4E8CC]/80 z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 relative border-[#E7E7E7] border-[1px] gap-y-4">
            <h2 className="text-[20px] font-semibold text-[#2D60FF]">{popupTitle}</h2>
            ...
            <div className='flex flex-row items-center justify-end gap-x-2 mt-4'>
                ...
                <button
                    ...
                    className="pt-2 pr-4 pb-2 pl-4 bg-[#2D60FF] text-white text-sm rounded-[8px] font-md hover:bg-[#1A4BBF] transition-colors duration-200"
                >
                    {t('no')}
                </button>
            </div>
